          ...
          {navigationItems.map((item) => (
            item.id === 'organizations' || item.id === 'ai-management' ? (
              <Link href={item.path} key={item.id}>
                <button
                  className={`w-full p-4 rounded-xl transition-all duration-300 flex items-center gap-4 text-left group glass hover:glass-dark card-hover ${item.id === 'ai-management' ? 'mt-6' : ''}`}
